...
<div class="content container-fluid">
    @foreach($employees as $employee)
        ...
        <div class="card mb-0">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="profile-view">
                                            ...
                                            <div class="col-md-7">
                                                <ul class="personal-info">
                                                    <li>
                                                        ...
                                                        <div class="text"><a href="">{{  $employee->mobile_number }}</a></div>
                                                    </li>
                                                    <li>
                                    ...
                                    <div class="pro-edit"><a data-target="#profile_info_{{ $employee->user_id }}" data-toggle="modal" class="edit-icon" href="{{ url('/employee_edit_profile',['id' => $employee->user_id ]) }}"><i class="fa fa-pencil"></i></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div id="profile_info_{{ $employee->user_id }}" class="modal custom-modal fade" role="dialog">
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="form" method="POST" action="{{ url('/employee_update_profile',['id' => $employee->user_id ]) }}">
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="cal-icon">
                                                        <input class="form-control datetimepicker" type="text" value="{{ $employee->date_of_birth }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Address</label>
                                            <input type="text" class="form-control" value="{{ $employee->permanent_address }} ">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{ $employee->mobile_number }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
